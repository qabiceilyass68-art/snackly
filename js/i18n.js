...
const DICT = {
  ar: {
    ...
    hero_sub: "اطلب بضع نقرات ونوصلك الأطباق ساخنة. توصيل سريع.",
    ...
    track_cancel_confirm: "هل تريد فعلاً إلغاء هذا الطلب؟",
  ...
  fr: {
    ...
    hero_sub: "Commandez en quelques clics, on vous livre les plats chauds. Livraison rapide.",
    ...
    compl_btn: "Envoyer une réclamation", compl_def: "Bonjour, j'ai une réclamation:", compl_ok: "WhatsApp s'ouvre pour écrire votre réclamation",
    header_reserve: "Réserver une table",
    lang_title: "Changer la langue", ar: "العربية", fr: "Français", en: "English", es: "Español",
    track_cancel: "Annuler la commande ❌",
    track_cancel_confirm: "Voulez-vous vraiment annuler cette commande ?",
  ...
  en: {
    ...
    hero_sub: "Order in a few clicks, delivered hot to your door. Fast delivery.",
    ...
    track_cancel_confirm: "Are you sure you want to cancel this order?",
  ...
  es: {
    ...
    hero_sub: "Pide en unos clics y te lo llevamos caliente. Entrega rápida.",
    ...
    reserve_err: "Completa todos los campos",
    drawer_t: "Carrito 🛒", drawer_total: "Total", drawer_checkout: "Pagar ✅",
    cart_empty: "El carrito está vacío.",
    remove_btn: "Quitar del carrito",
    ...
    track_cancel: "Cancelar pedido ❌",
    track_cancel_confirm: "¿Seguro que quieres cancelar este pedido?",
